...
//     alert("This video is protected, If you try to download this harm your system.");return false;
// });

$(function () {
$('.video-js.video-content').css({'height':'auto'});
});
...
`;
  ...
  var theme = "dore.greenlime.min.css";
  var direction = "ltr";
  var radius = "rounded";
  ...
  loadStyle("http://localhost/tradexexpert/asset/css/" + theme, onStyleComplete);
